...
public partial class resultsCycletimes {
    ...
    private string startedordersField;
    
    private string waitingordersField;
...
public partial class resultsCycletimesOrder {
    ...
    private string cycletimeminField;
